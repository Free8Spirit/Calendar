    ...
    // Then, we'll perform several operations on this array of days
        ...
        let paddedDays = _.map(days, day => { // Transforms items in the array
            ...
            // TODO: Highlight YOUR birthday in color!
                if(day.month() == 0 && day.date() == 27) {
                    date = chalk.inverse(date)
                    
                } else if (day.month() == 8 && day.date() == 10) {  //my birthday
                    date = chalk.magenta.bgGreen(date)
                }
            ...
            paddedDays.forEach(week => { //[ , , , 01, 02]
                ...
                week.join('days') // TODO: Join the days together to form one string representing the week
